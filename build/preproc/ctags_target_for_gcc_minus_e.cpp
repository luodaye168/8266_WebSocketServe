...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t *payload, size_t length)
{
    ...
    case WStype_TEXT:
        ...
        for (size_t i = 0; i < length; i += 3) // 每个16进制数之间有一个空格，所以长度为3
        {
            ...
            data[dataIndex] = strtol(hexByte, 
# 95 "c:\\Users\\stars\\Desktop\\8266_WebSocketServer\\WebSocketServer_LEDcontrol.ino" 3 4
                                             __null
# 95 "c:\\Users\\stars\\Desktop\\8266_WebSocketServer\\WebSocketServer_LEDcontrol.ino"
                                                 , 16);
            dataIndex++;
        }
